(function() {
    ...
    var D, F, G = function(a) {
        ...
        for (var b = [], c = 0; c < a.length; c += 3) {
            var d = c + 1 < a.length, e = c + 2 < a.length, g = a.charCodeAt(c), f = d ? a.charCodeAt(c + 1) : 0, h = e ? a.charCodeAt(c + 2) : 0, m = g >> 2;
            g = (g & 3) << 4 | f >> 4;
            f = (f & 15) << 2 | h >> 6;
            h &= 63;
            e || (h = 64, d || (f = 64));
    ...
    var aa = function(a, b, c) {
        ...
        b = d(b, "?"), c = d(c, "#"), r.history.replaceState({}, void 0, "" + a + b + c));
    }, U = function(a) {
        var b = void 0 === b ? 3 : b;
        try {
            if (a) {
    ...
    function Y(a, b) {
        if (b && b.action) {
            ...
            if ("get" === c) {
                ...
                d || (c = u.createElement("input"), c.setAttribute("type", "hidden"), c.setAttribute("name", "_gl"), 
                c.setAttribute("value", a), b.appendChild(c));
...
(function() {
        ...
        e.onload = function() {
            ...
            if (4 == e.readyState) {
                try {
                    ...
                    g.optOut ? (J(63), Qc("", "$OPT_OUT", 31536e6)) : g.clientId ? Qc(g.clientId, g.securityToken, 31536e6) : !c && g.alternateUrl ? (Ga && clearTimeout(Ga), 
    ...
    var ad = void 0, bd = function(a) {
        ...
        c = c || ua;
        if (2036 >= b.length) wc(a, b, c); else if (8192 >= b.length) x(a, b, c) || wd(a, b, c) || wc(a, b, c); else throw ge("len", b.length), 
        new Da(b.length);
    }, pe = function(a, b, c, d) {
        d = d || ua;
        wd(a + "?" + b, "", d, c);
        ...
        g.onreadystatechange = function() {
            if (4 == g.readyState) {
                if (d) try {
                    ...
                    if (1 > ca.length) ge("xhr", "ver", "0"), c(); else if ("1" != ca.charAt(0)) ge("xhr", "ver", String(ca.length)), 
                    c(); else if (3 < d.count++) ge("xhr", "tmr", "" + d.count), c(); else if (1 == ca.length) c(); else {
                        var l = ca.charAt(1);
        ...
        a.push("z=" + hd()), wc(ad ? ad + "/33" : bd(!0) + "/u/d", a.join("&"), ua));
    };
    var h = function(a) {
    ...
    var aa = function(a) {
        ...
        if (Ec(b) || Fc(b)) {
            var c = b[Eb];
            void 0 == c || Infinity == c || isNaN(c) || (0 < c ? (Y(b, Gb), Y(b, Jb), Y(b, Ib), 
            Y(b, Fb), Y(b, Hb), Y(b, Kb), Y(b, Lb), Y(b, Ve), Y(b, We), Y(b, Xe), Y(b, Ye), 
            va(function() {
                a(b);
    ...
    var hc = !1, mc = function(a) {
        ...
        if (!a || 1 > a.length) J(12); else {
            for (var d = [], e = 0; e < a.length; e++) {
                ...
                var ca = g.split(".");
                var l = ca.shift();
                ("GA1" == l || "1" == l) && 1 < ca.length ? (g = ca.shift().split("-"), 1 == g.length && (g[1] = "1"), 
                g[0] *= 1, g[1] *= 1, ca = {
                    H: g,
                    s: ca.join(".")
                }) : ca = kd.test(g) ? {
    ...
    var qd = function(a, b, c) {
        ...
        if (b && b.action) if ("get" == b.method.toLowerCase()) {
            ...
            for (var c = 0; c < a.length; c++) {
                ...
                ca || (g = M.createElement("input"), g.setAttribute("type", "hidden"), g.setAttribute("name", d), 
    ...
    Dc.prototype.S = function(a, b, c) {
        ...
        this.target.get(Ze) ? De.auto(function() {
            return $e(e.target);
        }, a, b ? "fragment" : "", c) : (this.T || (this.T = !0, L(M, "mousedown", d, !1), 
        L(M, "keyup", d, !1)), c && L(M, "submit", function(g) {
            g = g || O.event;
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, pc = function(a) {
        ...
        if (a.get(Hd) && (c = be("_ga", !!a.get(cc)), g = be("_gl", !!a.get(cc)), d = De.get(a.get(cc)), 
        e = d._ga, g && 0 < g.indexOf("_ga*") && !e && J(30), g = d.gclid, ca = d._gac, 
        c || e || g || ca)) if (c && e && J(36), a.get(bc) || ye(a.get(Kd))) {
            if (e && (J(38), a.data.set(Q, e), d._gid && (J(51), a.data.set(I, d._gid))), g ? (J(82), 
            a.data.set(ce, g), d.gclsrc && a.data.set(ie, d.gclsrc)) : ca && (d = ca.split(".")) && 2 === d.length && (J(37), 
            a.data.set(ce, d[0]), a.data.set(fe, d[1])), c) b: if (d = c.indexOf("."), -1 == d) J(22); else {
                e = c.substring(0, d);
                g = c.substring(d + 1);
                d = g.indexOf(".");
                c = g.substring(0, d);
                ...
                J(11);
                a.data.set(Q, d);
                if (c = be("_gac", !!a.get(cc))) c = c.split("."), "1" != c[0] || 4 != c.length ? J(72) : ke(c[3], c[1]) ? J(71) : (a.data.set(ce, c[3]), 
                a.data.set(fe, c[2]), J(70));
            }
        } else J(21);
        b && (J(9), a.data.set(Q, K(b)));
        a.get(Q) || ((b = (b = O.gaGlobal && O.gaGlobal.vid) && -1 != b.search(jd) ? b : void 0) ? (J(17), 
        a.data.set(Q, b)) : (J(8), a.data.set(Q, ra())));
    ...
    var td = /^(?:(\w+)\.)?(?:(\w+):)?(\w+)$/, sc = function(a) {
        if (ea(a[0])) this.u = a[0]; else {
            var b = td.exec(a[0]);
            null != b && 4 == b.length && (this.c = b[1] || "t0", this.K = b[2] || "", this.C = b[3], 
    ...
    var u = function(a, b, c) {
        ...
        if (!ea(Yd.get(b)) && !$d.get(b)) {
            ...
            if (p.test(b)) {
                ...
                c = c.palindrome ? r : q, c = (c = M.cookie.replace(/^|(; +)/g, ";").match(c)) ? c.sort().join("").substring(1) : void 0, 
                d.la = c, d.qa = E(a.b.get(kb) || "", "gclid"));
                a = d.B;
                c = new Date().getTime();
                O[a] = O[a] || [];
                c = {
            ...
            d = ae(c), a = d.protocol, c = M.location.protocol, ("https:" == a || a == c || ("http:" != a ? 0 : "http:" == c)) && B(d))) {
                if (d = d.url) a = (a = M.querySelector && M.querySelector("script[nonce]") || null) ? a.nonce || a.getAttribute && a.getAttribute("nonce") || "" : "", 
                e ? (e = "", a && Nd.test(a) && (e = ' nonce="' + a + '"'), f.test(d) && M.write("<script" + e + ' src="' + d + '"><\/script>')) : (e = M.createElement("script"), 
                e.type = "text/javascript", e.async = !0, e.src = d, a && e.setAttribute("nonce", a), 
                d = M.getElementsByTagName("script")[0], d.parentNode.insertBefore(e, d));
                $d.set(b, !0);
            }
        }
    }, v = function(a, b) {
